...
//        }
    ...
    public static void nouveau(JaxeFrame jframe) {
        synchronized (lock) {
            ...
            System.out.println("Calling nouveau " );
            try {
    ...
    public static void ouvrir(final File f, final JaxeFrame jframe) {
    	System.out.println("open frame with a file");
...
//                finDialogueDepart();
            for (final JaxeFrame ji : allFrames) {
                if (ji.doc != null && f.equals(ji.doc.fsave)) {
                	System.out.println("inside doc not null");
                    ji.toFront();
                    return;
                }
            }
    ...
    public static void main(final String args[]) {
        if (System.getProperty("jaxe.config") != null) { // lancement sans argument
        	System.out.println(System.getProperty("jaxe.config"));
            ...
            new Jaxe(args[0]);
            nouveau(null);
            System.out.println("Calling nouveau null" );
            ...
            System.out.println("Calling nouveau with arguments" );
            ...
            if (!dir.exists()) {
            	System.out.println("Calling else... dir" );
            ...
            if (nbconf == 0) {
            	System.out.println("Calling else... nbconf == 0" );
            ...
            if (args.length > 0)
                ...
                synchronized (lock) { // synchronisation avec MacJaxe.ouvrir
                    if (allFrames.size() == 0) {
                    	System.out.println("Calling else... allFrames.size() == 0" );
                        dialogueDepart();
                    }
                }
            } else if (nbconf == 1)
