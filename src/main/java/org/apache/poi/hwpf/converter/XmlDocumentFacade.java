...
public class XmlDocumentFacade {
   ...
   */
  public Map<String, Map<String, String>> stylesheet = new LinkedHashMap<String, Map<String, String>>();
 
  protected Element title;
  protected Text titleText;

  public XmlDocumentFacade( Document document )
  {
  ...
  {
  	styles = buildStylesheet(stylesheet);
  }
}
