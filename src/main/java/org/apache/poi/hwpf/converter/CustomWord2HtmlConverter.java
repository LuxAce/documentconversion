...
public class CustomWord2HtmlConverter  extends AbstractWordConverter {
	/**
  ...
  public final XmlDocumentFacade htmlDocumentFacade;
   ...
   */
  public CustomWord2HtmlConverter( Document document ) {
      this.htmlDocumentFacade = new XmlDocumentFacade( document );
  }
